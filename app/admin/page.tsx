        ...
        <div className="space-y-6">
          <div className="border border-border rounded-lg p-6">
            ...
            <div className="space-y-2">
              ...
              <a href="/admin/outlets" className="block px-4 py-2.5 text-sm bg-orange-50 text-orange-700 rounded-lg hover:bg-orange-100 transition-colors font-medium border border-orange-200">Manage Outlets</a>
