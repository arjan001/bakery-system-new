...
import { ChevronRight, Lock, Smartphone, Truck, Store, CheckCircle, Loader2 } from 'lucide-react';
...
export default function CheckoutPage() {
  ...
  const handlePlaceOrder = async (e: React.FormEvent) => {
    ...
    // Save order to database for M-Pesa payment
        ...
        <div className="grid lg:grid-cols-[1fr_400px] gap-10 items-start">
          ...
          <form onSubmit={handlePlaceOrder} className="space-y-7">
            ...
            <div>
              ...
              {/* M-Pesa Payment */}
              <div className="border border-gray-200 rounded-xl overflow-hidden">
                <label className="flex items-center gap-3 px-4 py-3.5 cursor-pointer bg-green-50">
                  <input type="radio" name="payment" value="mpesa" checked readOnly className="accent-orange-600" />
